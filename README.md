...
- `Resources`: data sources (read-only) that provide contextual information (file contents, database records, API records)
- `Prompts`: reusable templates that help structure interactions with language models (system prompts)
